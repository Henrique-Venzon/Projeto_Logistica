...
// Verificar se já existe o registro na tabela 'vistoriado' com base no 'id' da carga
$sql_verificar = "SELECT 1 FROM `vistoriado` WHERE `id` = '$id'";
$resultado_verificar = $conexao->query($sql_verificar);

if ($resultado_verificar->num_rows == 0) {
    // Não existe registro na tabela 'vistoriado' para esta carga, pode inserir
    ...
    // Já existe um registro de vistoria para esta carga
    header('location:../vistoriaCarga.php', true, 301);
    exit();
}
