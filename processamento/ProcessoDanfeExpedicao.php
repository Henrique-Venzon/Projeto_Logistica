...
$empresa = $_POST['empresa_destinatario'];
$base_calculo_issqn = $_POST['base_calculo_issqn']? $_POST['base_calculo_issqn'] : 0;
$inscricao_municipal = $_POST['inscricao_municipal']? $_POST['inscricao_municipal'] : 0;
$valor_total_servicos = $_POST['valor_total_servicos']? $_POST['valor_total_servicos'] : 0;
