...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    if (isset($_POST['finalizar'])) {
        ...
        if ($produto) {
            ...
            $stmt_check->bind_param("iss", $produto['posicao'], $produto['nome_produto'], $turma);
            $stmt_check->execute();
            ...
            if ($existing_product) {
                ...
                if ($stmt_insert->execute()) {
                    // Remova o registro da tabela 'pegado'
                    ...
                    die("Erro ao inserir no estoque: " . $stmt_insert->error);
                }
            }
        }
    }
