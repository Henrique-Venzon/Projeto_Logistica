                ...
                <div class='inputDanfe'>
                    <form action='processamento/ProcessoDanfe.php' method='post' id='danfeForm'>
                        <div class='section'>
                            ...
                            <input type='text' id='numerodef' name='numero' value='<?php echo $npedido ?>' required>
                        ...
                        <div class='section'>
                            ...
                            <input type='text' id='nome_razao_social_remetente' name='nome_razao_social_remetente'
                                   value="<?php echo $nome_cliente ?> " required>
                        ...
                        <div class='section'>
                            ...
                            <input type='number' id='quantidade' name='quantidade'
                                   value="<?php $quantidadeTotal = $quantidade1 + $quantidade2 + $quantidade3 + $quantidade4;
                        ...
                        <div class='section'>
                            ...
                            <input type='text' id='nome_produto1' name='nome_produto1' value='<?php echo $produto1; ?>'
                                   required>
