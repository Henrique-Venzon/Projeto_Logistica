...
$sql = "SELECT * FROM carga where turma_id =".$turma." ORDER BY id DESC LIMIT 1";
                    ...
                    <div class="inputDanfe">
                        <form action="processodanfe.php" method="post" id="danfeForm">
                            ...
                            <div class="section">
                                ...
                                <h2> Produto 1 </h2>
                                <label for="cod_prod1">Código do Produto</label>
                                <input type="text" id="cod_prod1" name="cod_prod1" value="<?php echo $produto1; ?>"
                                    required>

                                <label for="descricao_prod1">Descrição do Produto/Serviço</label>
                                <input type="text" id="descricao_prod1" name="descricao_prod1"
                                ...
                                <input type="number" step="0.01" id="valor_total_prod1" name="valor_total_prod1"
                                    value="<?php $total1=$valor1*$quantidade1; echo $total1; ?>" required>

                                <h2> Produto 2 </h2>
                                <label for="cod_prod2">Código do Produto</label>
                                <input type="text" id="cod_prod2" name="cod_prod2" value="<?php echo $produto2; ?>">

                                <label for="descricao_prod2">Descrição do Produto/Serviço</label>
                                <input type="text" id="descricao_prod2" name="descricao_prod2"
                                ...
                                <input type="number" step="0.01" id="valor_total_prod2" name="valor_total_prod2"
                                    value="<?php $total2=$valor2*$quantidade2; echo $total2; ?>">

                                <h2> Produto 3 </h2>
                                <label for="cod_prod3">Código do Produto</label>
                                <input type="text" id="cod_prod3" name="cod_prod3" value="<?php echo $produto3; ?>">

                                <label for="descricao_prod3">Descrição do Produto/Serviço</label>
                                <input type="text" id="descricao_prod3" name="descricao_prod3"
                                ...
                                <input type="number" step="0.01" id="valor_total_prod3" name="valor_total_prod3"
                                    value="<?php $total3=$valor3*$quantidade3; echo $total3; ?>">

                                <h2> Produto 4 </h2>
                                <label for="cod_prod4">Código do Produto</label>
                                <input type="text" id="cod_prod4" name="cod_prod4" value="<?php echo $produto4; ?>">

                                <label for="descricao_prod4">Descrição do Produto/Serviço</label>
                                <input type="text" id="descricao_prod4" name="descricao_prod4"
                                ...
                                <input type="number" step="0.01" id="valor_total_prod4" name="valor_total_prod4"
                                    value="<?php $total4=$valor4*$quantidade4; echo $total4; ?>">
