...
<head>
    ...
    <meta charset="utf-8">
    <title><?php
        $tituloPag = 'Controle Solicitação';
        echo "$tituloPag";
        ?></title>
                        ...
                        <table class="table">
                            ...
                            <?php if ($quantidade1 > 0) { ?>
                                <tr>
                                    ...
                                    <input name="id_doca" type="hidden" value="<?php echo $id_doca ?>">
                                    <input name="id_carga_select" type="hidden" value="<?php echo $id_carga_select ?>">
                                    <td><input type="number" name="quantidade_enviada1" min=0
                                               max="<?php echo $quantidade1; ?>"></td>
                            ...
                            <?php if ($quantidade2 > 0) { ?>
                                <tr>
                                    ...
                                    <td><input type="number" name="quantidade_enviada2" min=0
                                               max="<?php echo $quantidade2; ?>"></td>
                            ...
                            <?php if ($quantidade3 > 0) { ?>
                                <tr>
                                    ...
                                    <td><input type="number" name="quantidade_enviada3" min=0
                                               max="<?php echo $quantidade3; ?>"></td>
                            ...
                            <?php if ($quantidade4 > 0) { ?>
                                <tr>
                                    ...
                                    <td><input type="number" name="quantidade_enviada4" min=0
                                               max="<?php echo $quantidade4; ?>"></td>
