                                ...
                                <table class='table'>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <input name="quantidade1" id="quantidadeInput1" type="text" value="<?php echo $quantidade1 ?? 0; ?>" style="display:none;" />
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <input name="quantidade2" id="quantidadeInput2" type="text" value="<?php echo $quantidade2; ?>" style="display:none;" />
                                        </td>
                                        <td><span id="valor2"><?php echo $valor2; ?></span></td>
                                        <td><button type="button" id="editar2" onclick="editarQuantidade(2)">editar</button></td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <input name="quantidade3" id="quantidadeInput3" type="text" value="<?php echo $quantidade3; ?>" style="display:none;" />
                                        </td>
                                        <td><span id="valor3"><?php echo $valor3; ?></span></td>
                                        <td><button type="button" id="editar3" onclick="editarQuantidade(3)">editar</button></td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <input name="quantidade4" id="quantidadeInput4" type="text" value="<?php echo $quantidade4; ?>" style="display:none;" />
                                        </td>
                                        <td><span id="valor4"><?php echo $valor4; ?></span></td>
                                        <td><button type="button" id="editar4" onclick="editarQuantidade(4)">editar</button></td>
