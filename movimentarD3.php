                ...
                <div class="flex">
                    ...
                    <form method='post' action="processamento/selecionar_carga.php">
                        ...
                        if ($qtd > 0) {
                            ...
                            while ($row = $res->fetch_object()) {
                                ...
                                echo"<input type='hidden' name='doca' value='D3'>";
                                echo"<input type='hidden' name='doca_id_real' value='3'>";
                                echo "</tr>";
                            }
                            print "</table>";
                            print "</div>";
                    ...
                    if ($qtd > 0) {
                        ...
                        while ($row = $res->fetch_object()) {
                            ...
                            print "<td>
                                    <form method='post' action='processamento/processar_movimentacaoD3.php' style='display:inline-block'>
