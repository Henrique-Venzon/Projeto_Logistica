            ...
            <div class="table-inputs">
                ...
                <div class="flex">
                    ...
                    <form method='post' action="processamento/selecionar_carga.php">
                        ...
                        $sql = "SELECT * FROM `movimentacao` where id_doca='2' ORDER BY `movimentacao`.`id` ASC";
                        $res = $conn->query($sql);
                        $qtd = $res->num_rows;
                    ...
                    <?php
                    $sql = "SELECT * FROM pegado where id_doca=2";
                    $res = $conn->query($sql);
                    $qtd = $res->num_rows;
                    ...
                    if ($qtd > 0) {
                        ...
                        while ($row = $res->fetch_object()) {
                            ...
                            print "<td>
                                    <form method='post' action='processamento/processar_movimentacaoD2.php' style='display:inline-block'>
