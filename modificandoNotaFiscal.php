                ...
                <div class='inputDanfe'>
                    <form action='processamento/update_notafiscal.php' method='post' id='danfeForm'>
                        <div class='section'>
                            ...
                            <input type='text' id='protocolo_autorizacao' name='protocolo_autorizacao'
                                   value='<?php echo $protocolo_autorizacao; ?>' required>
                            ...
                            <input type='text' id='inscricao_estadual_subs_tributaria'
                                   ...
                                   value='<?php echo $inscricao_estadual_subs_tributaria; ?>' required>

                            <label for='natureza_operacao'>Natureza da Operação</label>
                            <input type='text' id='natureza_operacao' name='natureza_operacao'
                                   value='<?php echo $natureza_operacao; ?>' required>

                            <label for='inscricao_estadual'>Inscrição Estadual</label>
                            <input type='text' id='inscricao_estadual' name='inscricao_estadual'
                                   value='<?php echo $inscricao_estadual; ?>' required>
                        </div>
                        ...
                        <div class='section'>
                            ...
                            <input type='text' id='cnpj_cpf_remetente' name='cnpj_cpf_remetente'
                                   value='<?php echo $cnpj_cpf_remetente; ?>' required>
                            ...
                            <input type='text' id='Empresa_remetente' name='Empresa_remetente'
                                   value='<?php echo $empresa ?>' required>
                            ...
                            <input type='date' id='data_entrada_saida' name='data_entrada_saida'
                                   value='<?php echo $data_entrada_saida; ?>' required>

                            <label for='hora_saida'>Hora de Saída</label>
                            <input type='time' id='hora_saida' name='hora_saida' value='<?php echo $hora_saida; ?>'
                                   required>

                            <label for='fatura_duplicata'>Fatura/Duplicata</label>
                            <input type='text' id='fatura_duplicata' name='fatura_duplicata'
                                   value='<?php echo $fatura_duplicata; ?>' required>

                            <label for='forma_pagamento'>Forma de Pagamento</label>
                            <input type='text' id='forma_pagamento' name='forma_pagamento'
                                   value='<?php echo $forma_pagamento; ?>' required>
                        </div>
                        ...
                        <div class='section'>
                            ...
                            <input type='number' step='0.01' id='valor_icms' name='valor_icms'
                                   value='<?php echo $valor_icms; ?>' required>
                        ...
                        <div class='section'>
                            ...
                            <input type='text' id='inscricao_estadual_transportador'
                                   ...
                                   value='<?php echo $inscricao_estadual_transportador; ?>' required>
                        ...
                        <div class='section'>
                            ...
                            <input type='text' id='inscricao_municipal' name='inscricao_municipal'
                                   value='<?php echo $inscricao_municipal; ?>' required>
                            ...
                            <input type='number' step='0.01' id='valor_total_servicos' name='valor_total_servicos'
                                   value='<?php echo $valor_total_servicos; ?>' required>
                            ...
                            <input type='number' step='0.01' id='base_calculo_issqn' name='base_calculo_issqn'
                                   value='<?php echo $base_calculo_issqn; ?>' required>
                        </div>
                        <div class='section'>
                            <h2>Total</h2>
                            <label for='inscricao_municipal'>Valor Total dos Produtos</label>
                            <input type="number" id='total_produtos2' name='total_produtos'
                                   value='<?php echo $total_produtos; ?>'>

                            <label for='valor_total_servicos'>Valor Total da Nota</label>
                            <input type="number" id='valor_total_nota2' name='valor_total_nota'
                                   value='<?php echo $valor_total_nota; ?>'>
